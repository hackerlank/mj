...
function SurplusPosition:getMjArray()
	local surplus_pam = self._parent:getBeganSurplusPam()
	local seat = surplus_pam.seat
	local x = surplus_pam.x
	local dir = surplus_pam.dir  --顺/反
	--主要是方向问题 {}
	--上家、下家 从上到家
	--本家、对家 从左到右
	if dir then
